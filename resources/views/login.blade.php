...
<body>
    <h2>Klarna login</h2>
    <p>
      This is a simple example of how to use the Klarna login with Socialite.
    </p
    <p>
      Read the <a href="https://developers.klarna.com/en/us/checkout/button-styling-guide">Button Styling Guide</a> documentation.
    </p>
    ...
    <div class="box">
      <div class="preview">
        ...
        <div class="container">
          <p>
            <strong>Default button (Dark theme)</strong>
          </p>
        ...
        <div class="container">
          <p>
            <strong>Light button (Outlined theme)</strong>
          </p>
          <div class="klarna-sdk-button-container">
            <button id="klarna-sdk-button" class="theme-outlined shape-default" onclick="handleKlarnaLogin()">
              <div id="klarna-sdk-button__outline"></div>
              <div id="klarna-sdk-button__inner-container">
                <span id="klarna-sdk-button__text" class="">
                  <span id="klarna-sdk-button__text--center">
        ...
        <div class="container bg-dark">
          <p>
            <strong>Light button (to be used on dark backgrounds)</strong>
          </p>
          <div class="klarna-sdk-button-container">
            <button id="klarna-sdk-button" class="theme-light shape-default" onclick="handleKlarnaLogin()">
              <div id="klarna-sdk-button__outline"></div>
              <div id="klarna-sdk-button__inner-container">
                <span id="klarna-sdk-button__text" class="">
                  <span id="klarna-sdk-button__text--center">
      ...
      <div class="code">
        ...
        <script src="https://gist.github.com/taher435/741f51ccdf71d399b1d242b984f50287.js"></script>
      </div>
    </div>
</body>
</html>
